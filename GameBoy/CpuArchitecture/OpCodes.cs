...
namespace GameBoy.CpuArchitecture
{
    public static class OpCodes
    {
        ...
        public static readonly OpCode[] SingleByteOpCodes =
        {
            ...
            new OpCode(0x08, "LD (d16) SP", 20, 2, (cpu, i) => cpu.MemController.Write(i.Operand16, cpu.Registers.SP)),
            ...
            new OpCode(0x31, "LD SP d16",   12, 2, (cpu, i) => cpu.Registers.SP = i.Operand16),
            ...
            new OpCode(0x33, "INC SP",      8,  0, (cpu, i) => cpu.Registers.SP = cpu.Alu.Inc(cpu.Registers.SP)),
            ...
            new OpCode(0x39, "ADD HL SP",   8,  0, (cpu, i) => cpu.Registers.HL = cpu.Alu.Add(cpu.Registers.HL, cpu.Registers.SP)),
            ...
            new OpCode(0x3B, "DEC SP",      8,  0, (cpu, i) => cpu.Registers.SP = cpu.Alu.Dec(cpu.Registers.SP)),
